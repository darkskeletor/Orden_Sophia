  ...
  return (
    <div className="from-primary/5 via-background to-secondary/5 relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-gradient-to-br p-6">
      ...
      >
        ...
        <img src="/images/logo2.png" alt="Logo de la orden" className="h-10 w-10" />
      ...
      >
        <p className="text-foreground text-center text-sm font-bold">
          🏆 Práctica semanal: constancia consciente
        </p>
      </motion.div>
          ...
          <div className="flex flex-col items-center gap-8 p-12">
            ...
            <div className="space-y-2 text-center">
              ...
              <p className="text-muted-foreground">
                Un espacio para la atención y la respiración consciente
              </p>
            </div>
            ...
            <div className="relative flex h-48 w-48 items-center justify-center">
              ...
              <div className="relative z-10 text-center">
                ...
                <div className="text-muted-foreground font-hand mt-2 text-sm">
                  {isRunning &&
                    (breathPhase === 'inhale'
                      ? 'Inhala... observa la quietud'
                      : 'Exhala... suelta la tensión')}
                </div>
              </div>
            </div>
              ...
              <div className="text-center">
                ...
                >
                  ...
                  <span className="font-heading text-foreground font-bold">
                    {sessionsCompleted} prácticas completadas
                  </span>
                </motion.div>
                <p className="text-muted-foreground mt-2 text-xs">
                  {timeLeft === 0
                    ? 'La práctica ha concluido. Has sostenido la atención.'
                    : 'Permite que el cuerpo se relaje y asiente lo vivido.'}
                </p>
              </div>
            </div>
      ...
      >
        La comprensión se cultiva, respiración a respiración. ✨
      </motion.div>
    </div>
  );
};
